...
when :work
  PLACES = [
    ...
    # SQUIRTLE
    #[42.345109030431765,-71.03060128287004, "Mid+"],
    [42.34470056212993,-71.03125131415162, "Mid"],
    #[42.345056141080164,-71.02985838872819, "Here+"],
    ...
    #[42.34507203293618,-71.02995125056874, "Here+"],
    #[42.343577352330804,-71.02512240728822, "Get out (Dratini)"],
    # OTHER (MAGMAR, GEODUDE, MACHOP)
